  ...
  <div>
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="账号绑定" name="second">
              <ul>
                ...
                <li class="borderd pt-2.5">
                  <p class="pb-2.5 text-xl text-gray-600">登录密码</p>
                  <p class="pb-2.5 text-lg text-gray-400">
                    <a
      ...
      <el-form :model="phoneForm">
        ...
        <el-form-item label="验证码" label-width="120px">
          <div class="flex w-full gap-4">
            <el-input class="flex-1"  v-model="phoneForm.code" autocomplete="off" placeholder="" style="width:300px" />
    ...
    <el-dialog v-model="changeEmailFlag" title="绑定邮箱" width="600px">
      <el-form :model="emailForm">
        ...
        <el-form-item label="验证码" label-width="120px">
          <div class="flex w-full gap-4">
            <el-input class="flex-1" v-model="emailForm.code" placeholder="" autocomplete="off" style="width:300px" />
