...
import (
	...
	ast2 "github.com/bighuangbee/bee-admin/server/utils/ast"

	"github.com/bighuangbee/bee-admin/server/resource/autocode_template/subcontract"
...
func Init(Package string) {
	...
	packageInjectionMap = map[string]astInjectionMeta{
		packageServiceName: {
			...
			importCodeF:  "github.com/bighuangbee/bee-admin/server/%s/%s",
			packageNameF: "%s",
