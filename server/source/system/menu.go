...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "", Name: "https://www.xxx.com", Component: "/", Sort: 0, Meta: Meta{Title: "官方网站", Icon: "home-filled"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "25", Path: "https://plugin.xxx.com/", Name: "https://plugin.xxx.com/", Component: "https://plugin.xxx.com/", Sort: 0, Meta: Meta{Title: "插件市场", Icon: "shop"}},
